...
def main():
    ...
    # parse_formula(chemical_formula, periodic_table)
    compute_molar_mass(grams,periodic_table)
    

    # total_molar_mass = 0
    # for element_key, element_list in periodic_table.items():
    #     element = element_list[NAME_INDEX]
    #     atomic_mass = element_list[ATOMIC_MASS_INDEX]
    #     total_molar_mass += atomic_mass
    #     print(f"{total_molar_mass} grams/mole")
    #     moles = total_molar_mass / grams
    #     print(f"{moles} moles")
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for inner_key, inner_list in symbol_quantity_list:
        symbol = inner_list[SYMBOL_INDEX]
        quantity = inner_list[QUANTITY_INDEX]
        print(symbol, quantity)

    # total_molar_mass = 0
    # for inner_key, inner_list in periodic_table_dict.items():
